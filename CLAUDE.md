...
Healing Echoes is an AI campaign builder that turns a healer's workshop, service, or product into a complete multi-platform marketing campaign in their authentic voice.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "296507256+Liliyusoff@users.noreply.github.com"
  git config user.name "Liliyusoff"
  ```
